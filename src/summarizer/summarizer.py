...
요구사항:
1. **첫 줄에 제목 번역**: 영문 제목을 한국어로 번역하여 첫 줄에 "제목: 한글 번역" 형식으로 작성
2. 핵심 내용을 {self.max_summary_length}자 이내로 간결하게 요약
3. 기술적 용어는 설명을 추가
4. 주요 수치나 날짜가 있다면 포함
5. 왜 중요한지, 어떤 영향이 있을지 설명
6. 한국어로 작성
7. **중요**: 마크다운 형식으로 작성하되, 소제목은 반드시 H5(#####)부터 시작하세요
   - 예: ##### 핵심 내용, ##### 주요 기능, ##### 의미와 영향
8. H1, H2, H3, H4 헤딩은 절대 사용하지 마세요
